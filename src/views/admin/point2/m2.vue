...
import { isNull } from '@/utils/common'
  ...
  const state = reactive({
    ...
    content: [
      ...
      { width: 'w50x2', show: true, align: 'left', key: 'address', name: '寄存器ID', type: 'input', regex: /^[1-9]\d*$/, msg: '寄存器ID必须为大于0的有效整数'}, 
      ...
      { width: 'w50x2', show: true, align: 'left', key: 'len', name: '地址长度', type: 'input', regex: /^[0-9]+$/, msg: '地址长度只能输入整数'}, 
      { width: 'w50x2', show: true, align: 'left', key: 'point', name: '起始地址', type: 'input',regex: /^[0-9]+$/,msg: '起始地址只能输入整数'  },
      { width: 'w50x2', show: true, align: 'left', key: 'mode', name: '模式', type: 'select', list: modes, value: 'value', label: 'name'  },
      { width: 'w50x2', show: true, align: 'left', key: 'scale', name: '幅度', type: 'input', regex: /^\d+(\.\d+)?$/, msg: '幅度系数必须为有效数字（支持整数/小数）' },
      { width: 'w50x2', show: true, align: 'left', key: 'offset', name: '偏移', type: 'input', regex: /^[0-9]+$/,msg: '偏移系数只能输入整数'  },
    ...
    editFrom: [
      { required: true, editshow: true, name: '寄存器ID', key: 'address', type: 'input', regex: /^[1-9]\d*$/,msg: '寄存器ID必须为大于0的有效整数'}, 
      ...
      { required: true, editshow: true,  name: '起始地址', key: 'point', type: 'input',regex: /^[0-9]+$/,msg: '地址长度只能输入整数' },
      { required: true, editshow: true,  name: '选择模式', key: 'mode', type: 'select', list: modes, value: 'value', label: 'name' },
      { required: true, editshow: true,  name: '生成数量', key: 'pointNum', type: 'input',regex: /^[1-9]\d*$/, msg: '生成数量必须为大于0的有效整数'},
      { required: true, editshow: true,  name: '生成幅度', key: 'pointScale', type: 'input',regex: /^[1-9]\d*$/,msg: '地址长度只能输入整数' },
      { required: true, editshow: true,  name: '幅度系数', key: 'scale', type: 'input',regex: /^\d+(\.\d+)?$/, msg: '幅度系数必须为有效数字（支持整数/小数）' },
      { required: true, editshow: true,  name: '偏移系数', key: 'offset', type: 'input',regex: /^[0-9]+$/,msg: '偏移系数只能输入整数' },
    ],
    export: [
