						...
						<div class="flex1 flex-col">
							...
							<div class="flex1 flex-bc hidden">
								<div class="flex1 flex-col-cc hidden">
									...
									<span class="h10 w40 mts"></span>
									<span class="fw mt2">{{ publicStore._public.homeInfo&&publicStore._public.homeInfo.Operation_State1? publicStore._public.homeInfo.Operation_State1 : '0' }}</span>
								</div>
								<div class="flex1 flex-col-cc hidden">
									<span class="z1">停止</span>
									<span class="h10 w40 mts"></span>
									<span class="fw mt2">{{ publicStore._public.homeInfo&&publicStore._public.homeInfo.Operation_State0? publicStore._public.homeInfo.Operation_State0 : '0' }}</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="flex1 flex-col">
							...
							<div class="flex1 flex-bc hidden">
								<div class="flex1 flex-col-cc hidden">
									<span class="z1">运行</span>
									<span class="h10 w40 mts"></span>
									<span class="fw mt2">{{ publicStore._public.photovoltaicInfo&&publicStore._public.photovoltaicInfo.Operation_State1? publicStore._public.photovoltaicInfo.Operation_State1 : '0' }}</span>
								</div>
								<div class="flex1 flex-col-cc hidden">
									<span class="z1">停止</span>
									<span class="h10 w40 mts"></span>
									<span class="fw mt2">{{ publicStore._public.photovoltaicInfo&&publicStore._public.photovoltaicInfo.Operation_State0? publicStore._public.photovoltaicInfo.Operation_State0 : '0' }}</span>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="flex-cc flex1">
					<div class="flex-ss w50x4 plr10">
						...
						<div class="flex1 flex-col">
							...
							<div class="flex1 flex-bc hidden">
								<div class="flex1 flex-col-cc hidden">
									<span class="z1">放电</span>
									<span class="h10 w40 mts"></span>
									<span class="fw mt2">{{ publicStore._public.energyInfo&&publicStore._public.energyInfo.Operation_State1? publicStore._public.energyInfo.Operation_State1 : '0' }}</span>
								</div>
								<div class="flex1 flex-col-cc hidden">
									<span class="z1">充电</span>
									<span class="h10 w40 mts"></span>
									<span class="fw mt2">{{ publicStore._public.energyInfo&&publicStore._public.energyInfo.Operation_State0? publicStore._public.energyInfo.Operation_State0 : '0' }}</span>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="flex1 flex-col">
							...
							<div class="flex1 flex-bc hidden">
								<div class="flex1 flex-col-cc hidden">
									<span class="z1">运行</span>
									<span class="h10 w40 mts"></span>
									<span class="fw mt2">{{ publicStore._public.chargeInfo&&publicStore._public.chargeInfo.Operation_State1? publicStore._public.chargeInfo.Operation_State1 : '0' }}</span>
								</div>
								<div class="flex1 flex-col-cc hidden">
									<span class="z1">停止</span>
									<span class="h10 w40 mts"></span>
									<span class="fw mt2">{{ publicStore._public.chargeInfo&&publicStore._public.chargeInfo.Operation_State0? publicStore._public.chargeInfo.Operation_State0 : '0' }}</span>
								</div>
							</div>
						</div>
					</div>
