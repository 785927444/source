...
<script lang="ts" setup>
  ...
  const state = reactive({
    ...
    content: [
      ...
      { width: 'w50x4', show: true, align: 'left', key: 'sensor_name', name: '设备名称' },
      { width: 'w50x4', show: true, align: 'left', key: 'instlPos', name: '安装位置' },
      { width: 'w50x4', show: true, align: 'left', key: 'code_name', name: '控制名称' },
      { width: 'w50x4', show: true, align: 'left', key: 'action_name', name: '动作名称' },
      ...
      { width: 'w50x4', show: true, align: 'left', key: 'userName', name: '操作人员' },
      { width: 'w50x4', show: true, align: 'left', key: 'result', name: '结果', type: 'select', list: res, value: 'value', label: 'name' },
