  ...
  <div class="layout-col">
    ...
    <div class="ww100 flex-sc bs9 h40 mb15">
      ...
      <div class="flex1 hh100 flex-ec">
        ...
        <span class="ml15 cc">诊断检测</span>
        <span class="mlr10 cc">/</span>
        <span class="mr15">报警记录</span>
...
<script lang="ts" setup>
  ...
  const state = reactive({
    ...
    content: [
      ...
      { width: 'w50x4', show: true, align: 'left',  key: 'sensor_name', name: '传感器名称' },
      { width: 'w50x4', show: true, align: 'left',  key: 'sensor_instlPos', name: '安装位置' },
      { width: 'w50x4', show: true, align: 'left',  key: 'alarm_time', name: '报警时间', type: 'time' },
      { width: 'w50x3', show: true, align: 'left',  key: 'activation_count', name: '报警次数' },
      { width: 'w50x3', show: true, align: 'left',  key: 'alarm_name', name: '报警类型' },
      { width: 'w50x3', show: true, align: 'left',  key: 'clear_type', name: '处理状态', type: 'find', value: [logType, 'value', 'name'] },
      { width: 'w50x4', show: true, align: 'left',  key: 'clear_time', name: '处理时间', type: 'time' },
      { width: 'w50x3', show: true, align: 'left',  key: 'clear_description', name: '处理方案' },
      { width: 'w50x3', show: true, align: 'left',  key: 'clear_by_name', name: '处理人员' },
  ...
  const init = async () => {
    let args = `sensor_stationNum='${configStore.distributId}' and `
    ...
    if(!proxy.isNull(state.datetime)){
      ...
      args += `alarm_time>='${start}' and alarm_time<='${end}' and `
    }
    let q1 = {limit: state.limit, page: state.page}
    let q2 = {field: `COUNT(*)`}
    let qs = args? {model: `t_sensor_alarm_log`, args: args.slice(0, -4), order: 'alarm_time desc'} : {model: `t_sensor_alarm_log`, order: 'alarm_time desc'}
    let query1 = {}
    let query2 = {}
